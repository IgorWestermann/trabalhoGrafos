...
//     GraphIntersecao(){};
//     GraphIntersecao(vector<NodeList> nodes)
//     {
//         for (int i = 0; i < nodes.size(); i++)
//         {
//             nodesList.push_back(nodes);
//             addVertex(nodes[i].node_1);
//             addVertex(nodes[i].node_2);
//             addEdge(nodes[i].node_1, nodes[i].node_2, nodes[i].weight);
//         }
//     };

//     GraphIntersecao montaIntersecao(Graph g)
//     {
